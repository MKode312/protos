...
func (c *authClient) RegisterAsAdmin(ctx context.Context, in *RegisterAsAdminRequest, opts ...grpc.CallOption) (*RegisterAsAdminResponse, error) {
	...
	err := c.cc.Invoke(ctx, Auth_RegisterAsAdmin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auth_RegisterAsAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AuthServer).RegisterAsAdmin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_RegisterAsAdmin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RegisterAsAdmin(ctx, req.(*RegisterAsAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Auth_RegisterAsAdmin_Handler,
		},
		{
			MethodName: "IsAdmin",
	...
	Metadata: "LibAssistant/sso/sso.proto",
}
